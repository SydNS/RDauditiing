...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rate_level', models.PositiveSmallIntegerField(choices=[('1', '1/10'), ('2', '2/10'), ('3', '3/10'), ('4', '4/10'), ('5', '5/10'), ('6', '6/10'), ('7', '7/10'), ('8', '8/10'), ('9', '9/10'), ('10', '10/10')])),
                ('deptnem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.department')),
